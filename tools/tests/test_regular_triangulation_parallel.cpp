/**
 * https://doc.cgal.org/latest/Triangulation_3/Triangulation_3_2parallel_insertion_and_removal_in_regular_3_8cpp-example.html
 */
...
int main()
{
  ...
  assert(rtr.is_valid());
#else
  printf("CGAL not compiled in parallel mode!\n");
